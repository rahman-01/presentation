...
subtitle: "Belajar Presentation Ninja"
author: "Rahmansyah,A.Md"
institute: "Dunia akan  lebih baik, percaya tuhan tidak tidur"
date: "2020/7/25 (updated: `r Sys.Date()`)"
output:
...
.footnote[
[1] ??????????????????[????????????](http://slides.yihui.org/xaringan/zh-CN.html)
